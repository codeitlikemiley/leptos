...
#[cfg(any(feature = "tokio", all(feature = "wasm-bindgen", target_arch = "wasm32", target_os = "unknown"), feature = "glib"))]
#[cold]
#[inline(never)]
fn no_op_poll() {}

#[cfg(all(not(all(feature = "wasm-bindgen", target_arch = "wasm32", target_os = "unknown")), not(debug_assertions)))]
#[cold]
#[inline(never)]
...
#[cfg(all(feature = "wasm-bindgen", target_arch = "wasm32", target_os = "unknown"))]
#[cold]
#[inline(never)]
fn no_op_spawn(_: PinnedFuture<()>) {
    panic!(
...
impl Executor {
    ...
    pub async fn tick() {
        ...
        #[cfg(not(all(feature = "wasm-bindgen", target_arch = "wasm32", target_os = "unknown")))]
...
impl Executor {
    ...
    #[cfg(all(feature = "wasm-bindgen", target_arch = "wasm32", target_os = "unknown"))]
    #[cfg_attr(docsrs, doc(cfg(all(feature = "wasm-bindgen", target_arch = "wasm32", target_os = "unknown"))))]
